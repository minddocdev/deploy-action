...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const code = helm_1.setupHelmChart(namespace, release, chart, valueFiles, [`${imageTagKey}=${context.sha}`]).code;
            ...
            if (slackWebhook) {
                ...
                slack_1.sendSlackMessage(state, `${context.repo.owner}/${context.repo.repo}`, context.ref, context.actor, app, appUrl, context.sha, release, slackWebhook, sentryOrg);
            }
        }
        catch (error) {
